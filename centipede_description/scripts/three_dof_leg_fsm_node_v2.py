...
'''
# Name: three_dof_leg_fsm_node_v2.py
...
class MoveToTargetPos(State):
    ...
    Attributes:
        ...
        hip_angle_topic     (str): subscribe to hip joint angle
        hip_cmd_topic       (str): publish to hip joint controller
        knee_angle_topic    (str): subscribe to hip joint angle
        knee_cmd_topic      (str): publish to knee joint controller
        ankle_angle_topic   (str): subscribe to hip joint angle
        ankle_cmd_topic     (str): publish to ankle joint controller
    ...
    def __init__(self, hip_target_pos, knee_target_pos, ankle_target_pos,
                 hip_angle_topic, hip_cmd_topic, knee_angle_topic, knee_cmd_topic,
                 ankle_angle_topic, ankle_cmd_topic, pub_to_master_topic, success_trigger_msg,
...
class WaitForMasterCmd(State):
    ...
    Attributes:
        ...
        hip_cmd_topic       (str): publish to hip joint controller
        knee_angle_topic    (str): subscribe to hip joint angle
        knee_cmd_topic      (str): publish to hip joint controller
        ankle_angle_topic   (str): subscribe to hip joint angle
        ankle_cmd_topic     (str): publish to hip joint controller
        sub_to_master_topic (str): subscribe to master
        master_trigger_msgs (list of str): recognized commands from master
        ros_rate            (float)
        instance_name       (str)
    """
    def __init__(self, hip_angle_topic, hip_cmd_topic, knee_angle_topic, knee_cmd_topic,
                 ankle_angle_topic, ankle_cmd_topic, sub_to_master_topic,
...
def parse_args(args):
    ...
    parser.add_argument('-from_hip', type=str, required=True, help="hip_angle_topic")
    parser.add_argument('-to_hip', type=str, required=True, help="hip_cmd_topic")
    parser.add_argument('-from_knee', type=str, required=True, help="knee_angle_topic")
    parser.add_argument('-to_knee', type=str, required=True, help="knee_cmd_topic")
    parser.add_argument('-from_ankle', type=str, required=True, help="ankle_angle_topic")
    parser.add_argument('-to_ankle', type=str, required=True, help="ankle_cmd_topic")
...
def main():
    ...
    hip_angle_topic = parser.from_hip
    hip_cmd_topic = parser.to_hip
    knee_angle_topic = parser.from_knee
    knee_cmd_topic = parser.to_knee
    ankle_angle_topic = parser.from_ankle
    ankle_cmd_topic = parser.to_ankle
