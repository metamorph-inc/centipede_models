...
def main():
    ...
    trig_sub_topic = parser.from_segment
    trig_pub_topic = parser.to_segment
    ...
    leg_lift = MoveLeg(-1.57079633, 0.0, side, knee_sub_topic, hip_sub_topic, knee_pub_topic, hip_pub_topic, trig_pub_topic, ros_rate, 'Done', 'leg_lift')
    ...
    leg_plant = MoveLeg(-0.34906585, 0.261799, side, knee_sub_topic, hip_sub_topic, knee_pub_topic, hip_pub_topic, trig_pub_topic, ros_rate, 'Done', 'leg_plant')
    ...
    leg_push = MoveLeg(-0.34906585, -0.261799, side, knee_sub_topic, hip_sub_topic, knee_pub_topic, hip_pub_topic, trig_pub_topic, ros_rate, 'Done', 'leg_push')
